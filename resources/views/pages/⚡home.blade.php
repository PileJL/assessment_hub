...
<div class="min-h-screen flex flex-col justify-center items-center pb-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
        ...
        {{-- admin option --}}
        <div class="flex flex-col gap-3 items-center justify-center rounded-xl border-2 border-muted/30 bg-white p-8 w-full md:w-xs text-center transition-all duration-300 hover:scale-105 hover:shadow-lg hover:border-green cursor-pointer group">
            {{-- applicant icon --}}
